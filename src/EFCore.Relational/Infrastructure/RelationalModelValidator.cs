...
namespace Microsoft.EntityFrameworkCore.Infrastructure
{
    ...
    public class RelationalModelValidator : ModelValidator
    {
        ...
        /// <summary>
        ///     Validates the compatibility of two indexes mapped to the same store index.
        /// </summary>
        ...
        /// <summary>
        ///     Validates the compatibility of two keys mapped to the same key constraint.
        /// </summary>
        /// <param name="key"> A key. </param>
        /// <param name="duplicateKey"> Another key. </param>
        /// <param name="keyName"> The name of the key constraint. </param>
        /// <param name="tableName"> The schema-qualified table name. </param>
        protected virtual void ValidateCompatible(
            [NotNull] IKey key,
